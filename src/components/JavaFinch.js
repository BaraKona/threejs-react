...
const JavaFinch = () => {
    return (
        <div className = "JavaFinch">
            ...
            <div className = "Jinfo1" data-tilt>
            ...
            <div className = "Jinfo2" data-tilt>
            ...
            <div className = "Jinfo3" data-tilt>
            ...
            <div className = "Jinfo4" data-tilt>
            ...
            <div className = "Jinfo5" data-tilt>
            ...
            <div className = "Jinfo6" data-tilt>
